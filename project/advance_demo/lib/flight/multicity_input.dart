        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: TextFormField(
                decoration: InputDecoration(icon: Icon(Icons.flight_takeoff, color: Colors.red), labelText: 'From'),
              ),
            ),
            Padding(
              padding: EdgeInsets.fromLTRB(0.0, 0.0, 64.0, 8.0),
              child: TextFormField(
                decoration: InputDecoration(icon: Icon(Icons.flight_land, color: Colors.red), labelText: 'To'),
              ),
            ),
            Row(
              children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(0.0, 0.0, 64.0, 8.0),
              child: TextFormField(
                decoration: InputDecoration(icon: Icon(Icons.person, color: Colors.red), labelText: 'Passengers'),
              ),
            ),
            Row(
              children: <Widget>[
